...
class NPWP extends Controller
{
    public function index(Request $request)
    {
		if(Session::get('userid'))
		{
			...
			return view('home.reports.NPWP.index')->with($data);
		}
		else
		{
    ...
    public function datatable(Request $request, $params)
	{
        if(Session::get('userid'))
		{
			...
			//return view('home.reports.NPWP.index');
		}
        else
        {
			header("cache-Control: no-store, no-cache, must-revalidate");
	...
	public function download(Request $request, $params)
    {
        if(Session::get('userid'))
		{
			...
			return Excel::download(new RptNPWP($periode, $data), 'Rpt NPWP DataWiz API '.$periode.'.xlsx');
		}
        else
        {
			header("cache-Control: no-store, no-cache, must-revalidate");

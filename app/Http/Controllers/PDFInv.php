        ...
        if(Session::get('userid'))
        {
            ...
            else
            {
                ...
                for($i = 0; $i < count($bs); $i++) 
                {
					...
					$newstatementdate 	= $bs[$i]->NEWSTATEMENTDATE;

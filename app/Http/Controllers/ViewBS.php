...
class ViewBS extends Controller
{
    public function bs(Request $request, $id)
    {
		if(Session::get('userid'))
		{
			if ($request->ajax()) 
			{
                $data = QueryBuilder::for(M_BS::class)  //DB::table('bs')
    ...
    public function pay(Request $request, $id)
    {
		if(Session::get('userid'))
		{
			if ($request->ajax()) 
			{
                $data = QueryBuilder::for(Mod_Payment::class)  //DB::table('trans')
                        ->where('master_company.id', $id)

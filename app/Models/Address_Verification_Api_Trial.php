...
class Address_Verification_Api_Trial extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_address_verification_trial';
    ...
    {
        return $query->where('datawhiz_app.api_address_verification_trial.nik', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_address_verification_trial.noapi_id', 'like', '%' . $search . '%');
    }
}

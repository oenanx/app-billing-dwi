...
class Home_Address_Api_Postpaid extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_home_address_postpaid';
    ...
    {
        return $query->where('datawhiz_app.api_home_address_postpaid.phoneno', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_home_address_postpaid.noapi_id', 'like', '%' . $search . '%');
    }
}

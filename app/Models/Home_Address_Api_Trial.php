...
class Home_Address_Api_Trial extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_home_address_trial';
    ...
    {
        return $query->where('datawhiz_app.api_home_address_trial.phoneno', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_home_address_trial.noapi_id', 'like', '%' . $search . '%');
    }
}

...
class M_BS extends Model
{
    ...
    //BSNO,PERIOD,CUSTOMERNO,USAGEADJUSTMENT,TOTALDISCOUNT,TOTALVAT,PREVIOUSBALANCE,BALANCEADJUSTMENT,PREVIOUSPAYMENT,DUEDATE,NEWSTATEMENTDATE,LASTSTATEMENTDATE,PAYMENTDATEVAT,TOTALAMOUNT,PENALTY,TOTALUSAGE,TOTALMATERAI
	...
	{
		DB::table('bs')->where('ID', $editid)->update($data);
	}
}

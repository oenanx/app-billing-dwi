...
class Negative_Record_Api_Postpaid extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_negative_record_postpaid';
    ...
    {
        return $query->where('datawhiz_app.api_negative_record_postpaid.nama', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_negative_record_postpaid.noapi_id', 'like', '%' . $search . '%');
    }
}

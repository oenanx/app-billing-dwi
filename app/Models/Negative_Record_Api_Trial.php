...
class Negative_Record_Api_Trial extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_negative_record_trial';
    ...
    {
        return $query->where('datawhiz_app.api_negative_record_trial.nama', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_negative_record_trial.noapi_id', 'like', '%' . $search . '%');
    }
}

...
class Office_Address_Api_Prepaid extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_work_address_prepaid';
    ...
    {
        return $query->where('datawhiz_app.api_work_address_prepaid.phoneno', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_work_address_prepaid.noapi_id', 'like', '%' . $search . '%');
    }
}

...
class PhoneHistory_Api_Postpaid extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'datawhiz_app.api_phonehistory_postpaid';
    ...
    {
        return $query->where('datawhiz_app.api_phonehistory_postpaid.phone_no', 'like', '%' . $search . '%')
                     ->orWhere('datawhiz_app.api_phonehistory_postpaid.phone_md5', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_phonehistory_postpaid.noapi_id', 'like', '%' . $search . '%');
    }
}

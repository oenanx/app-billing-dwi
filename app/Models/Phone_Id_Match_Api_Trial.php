...
class Phone_Id_Match_Api_Trial extends Model
{
	protected $connection = 'mysql_4';
    protected $table = 'api_phone_id_match_trial';
    ...
    {
        return $query->where('datawhiz_app.api_phone_id_match_trial.noapi_id', 'like', '%' . $search . '%')
                     ->orWhere('datawhiz_app.api_phone_id_match_trial.phoneno', 'like', '%' . $search . '%')
					 ->orWhere('datawhiz_app.api_phone_id_match_trial.nik', 'like', '%' . $search . '%');
    }
}

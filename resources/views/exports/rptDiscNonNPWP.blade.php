		...
		<div class="box box-info">
			<div class="box-body">
				<table style="width: 100%">
					<thead>
						<tr>
							<th colspan="10" style="text-align: center;">Report Discount Non NPWP DataWiz API Invoice Period : {{ $periode }}</th>
						</tr>
					</thead>
				</table>
				<table style="width: 100%">
					<thead>
						<tr>
							...
							<th style="border:1px solid black; text-align: center;">Total Discount</th>
					...
					<tbody>
						@foreach($data as $details)
							<tr>
								...
								<td style="border:1px solid black; text-align: right;">{{ $details->charge }}</td>

	...
	<div class="card-body" style="width:100%;">
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						<div class="input-group input-group-sm">
							...
							<input type="password" class="form-control" readonly name="old_pass" id="old_pass" placeholder="Old Password" value="{{ Session::get('pass1'); }}">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group input-group-sm">
							<label>New Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</label>
							<input type="password" class="form-control" name="passwordnew" id="passwordnew" required placeholder="New Password" onkeyup="validate();" />
							<span class="input-group-append">
								<span id="mybutton2" class="input-group-text"><i id="pass-status2" class="fa fa-eye-slash" onclick="showhide2()"></i></span>
							</span>
						</div>
					...
					<div class="form-group">
						<div class="input-group input-group-sm">
							...
							<input type="password" class="form-control" name="passwordconfirm" id="passwordconfirm" required placeholder="Confirm New Password" onkeyup="validate2();" />
							<span class="input-group-append">
								<button type="button" id="mybutton3" class="input-group-text"><i id="pass-status3" class="fa fa-eye-slash" onclick="showhide3()"></i></span>
							</span>
						</div>
		...
		<div class="row">
			<div class="col-md-12 col-lg-12">
				...
				<a href="{{ url('Change_Pass/change_pass') }}"><button type="button" class="btn btn-danger btn-sm" name="Batal">Cancel</button></a>
			</div>
		</div>
	</div>
</div>
...
$('body').on('click', '#Edit', function () 
{
	...
	var editurl = "{{ url('Change_Pass/update_pass') }}"
    $.ajax(
	{
        url : editurl,
        type: "GET",
        ...
        success: function(data)
        {
			...
			window.location="http://localhost/app-roboblast/public/index.php/logout";
        },

...
@section('pageTitle')
	<h1 class="text-dark font-weight-bold my-1 mr-1">Maintenance Periodic</h1>
    &nbsp;&nbsp;&nbsp;<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-md">
		...
		<li class="breadcrumb-item">
			<a href="" class="text-muted">Maintenance Periodic</a>
		</li>
	</ul>
@endsection
...
<div class="card card-custom" data-card="true" id="kt_card_1">
	<div class="card-header">
		<h3 class="card-title"><i class="fa fa-wrench"></i>&nbsp;&nbsp;Maintenance Billing Statement Periodic</h3>
	</div>
...
$(document).ready(function()
{
	...
	{
		var url = "{{ url('MaintenancePeriod/index') }}";

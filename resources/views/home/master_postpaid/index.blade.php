...
@section('pageTitle')
	<h1 class="text-dark font-weight-bold my-1 mr-5">List of Customers Postpaid</h1>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
		...
		<li class="breadcrumb-item">
			<a href="javascript:;" class="text-muted">2. Form Postpaid</a>
		</li>
		<li class="breadcrumb-item">
			<a href="{{ url('M_Prepaid/index') }}" class="text-muted">List of Customers Postpaid</a>
		</li>
	</ul>
@endsection
...
<div class="card card-custom" data-card="true" id="kt_card_2">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-th-list"></i> List of Customer Postpaid</h3>
		</div>
...
$(document).ready(function() 
{
    ...
    dataTable = $('#Show-Tables').KTDatatable(
	{
		...
		},
		{
			...
			template: function(row) {
				return '<p style="font-size:11px;">'+row.company_name+'</p>';
			}
		},
		{
			...
			template: function(row) {
				return '<p style="font-size:11px;">'+row.SALESAGENTNAME+'</p>';
			}
		},
		{
			field: 'billingtype',
			...
			width: 120,
            textAlign: 'center',
			title: '<p style="font-size:12px; text-align:center;">Billing Type</p>',
			template: function(row) {
				return '<p style="font-size:11px;">'+row.billingtype+'</p>';
			}
		},
		{
			field: 'active',
            ...
            template: function(row) {
                ...
                if (datas == "Active")
                {
                    return '<i class="ki ki-bold-check-1 text-success icon-sm" title="Live"></i>';
                }
                else
                {
                    return '<i class="ki ki-bold-close text-danger icon-sm" title="Not Actived"></i>';
                }
            }
		},
		{
			...
			template: function(row) 
			{
				return '<div class="btn-group">\
						<button type="button" class="btn btn-icon btn-xs btn-primary btn-hover-light-primary" data-toggle="dropdown" aria-expanded="false"><i class="ki ki-arrow-down icon-xs"></i>\
						</button>\
						<ul class="dropdown-menu dropdown-menu-right" role="menu" x-placement="bottom-start">\
							<li style="font-size:9pt;>\
								<a href="javascript:void(0)" class="dropdown-item viewCpy" data-id="'+row.customerno+'" title="View Customer">\
...
$('body').on('click', '.viewUsage', function () 
{
	...
	window.open("{{ url('RegistrationPostpaid/view_usage') }}"+'/'+id);
});

...
@section('pageTitle')
	<h4 class="text-dark font-weight-bold my-1 mr-5">View Usage API Product Postpaid</h4>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
		...
		<li class="breadcrumb-item">
			<a href="{{ url('M_Postpaid/index') }}" class="text-muted">2. Form Postpaid</a>
		</li>
		<li class="breadcrumb-item">
			<a href="javascript:;" class="text-muted">View Usage API Product Postpaid</a>
		</li>
	</ul>
@endsection
...
$(document).ready(function() 
{
			...
			dataTable = $('#Show-TablesAll').KTDatatable(
			{
				...
				data: 	
				{
					...
					source: {
						read: {
							//url: link,
							url: '{{ url('RegistrationPostpaid/datatableAll') }}'+'/'+params,
			...
			dataTable = $('#Show-Tables').KTDatatable(
			{
				...
				data: 	
				{
					...
					source: {
						read: {
							//url: link,
							url: '{{ url('RegistrationPostpaid/datatableusage') }}'+'/'+params,
							// sample custom headers
							// headers: {'x-my-custom-header': 'some value', 'x-test-header': 'the value'},
							map: function(raw) {
								// sample data mapping
	...
	$('#downloaddata').on("click", function ()
	{
		...
		var params = thn+''+bln+';'+prd+';'+customerno;
		console.log(params);
		var url = "{{ url('RegistrationPostpaid/downloadlog') }}"+'/'+params;

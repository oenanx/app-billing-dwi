...
@section('pageTitle')
	<h1 class="text-dark font-weight-bold my-1 mr-1">Payment</h1>
...
<div class="card card-custom card-collapsed" data-card="true" id="kt_card_1">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-edit"></i> Input Payment Customer</h3>
		</div>
...
<div id="view-modal1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="card">
				<div class="card-header">
					<h2 class="card-title" id="modelHeading2"><b>Edit Payment</b></h2>
				</div>

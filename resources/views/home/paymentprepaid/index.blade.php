...
@section('pageTitle')
	<h1 class="text-dark font-weight-bold my-1 mr-1">Payment Prepaid</h1>
    &nbsp;&nbsp;&nbsp;<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-md">
		...
		<li class="breadcrumb-item">
			<a href="" class="text-muted">Payment Prepaid</a>
		</li>
	</ul>
@endsection
...
<div class="card card-custom card-collapsed" data-card="true" id="kt_card_1">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-edit"></i> Input Payment Customer API Prepaid</h3>
		</div>
	...
	<div class="card-body">
		<form method="post" id="form1" name="form1" action="{{ url('InsertpaymentPrepaid') }}" enctype="multipart/form-data">
			@csrf
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-6">
					<div class="form-group">
						<label>Receipt</label>
						<input type="text" class="form-control form-control-sm" id="receipt" name="receipt" placeholder="Receipt #" autocomplete="Off" />
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<a href="{{ url('PaymentPrepaid/index') }}">
...
<div class="card card-custom" data-card="true" id="kt_card_2">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-th-list"></i> Payments Transaction Monthly</h3>
		</div>
		<div class="card-toolbar">
			<a href="#" class="btn btn-icon btn-sm btn-hover-light-primary mr-1" data-card-tool="toggle" data-toggle="tooltip" data-placement="top" data-original-title="Toggle Card">
                <i class="ki ki-arrow-down icon-nm"></i>
...
<div id="view-modal1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="card">
				<div class="card-header">
					<h2 class="card-title" id="modelHeading2"><b>Edit Payment Prepaid</b></h2>
				</div>

				<form method="post" id="form2" name="form2" action="{{ url('PaymentPrepaid/update') }}" enctype="multipart/form-data">
					@csrf
					<div class="card-body">
...
$(document).ready(function() 
{
	...
	var route = "{{ url('autocomplete-apiprepaidsearch') }}";
	...
	$("#cari").click(function ()
	{
		...
		$.get("{{ url('/cariAPIPrepaidCustomer') }}"+'/'+id, function (data) 
		{
	...
	{
		window.location="{{ url('PaymentPrepaid/index') }}";
	});
...
{     
	...
	$.get("{{ url('PaymentPrepaid/view') }}"+'/'+id, function (data) 
	{
...
$('body').on('click', '#Edit', function () 
{
    ...
    var editurl = "{{ url('PaymentPrepaid/update') }}";
	$.ajax({
		url : editurl,
		type: "GET",
...
{     
	...
	{
		type: "GET",
		url: "{{ url('PaymentPrepaid/delete') }}"+'/'+id,
		success: function (data) 
		{
			dataTable.reload();

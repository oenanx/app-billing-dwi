                ...
                <div class="col-xl-12 col-lg-7">
					...
					@csrf
                        ...
                        <div id="wiz1" name="wiz1" class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
							...
							<!--<div class="form-group row">
								<div class="col-md-4 col-lg-4 date">
									<div class="form-group">
                        ...
                        <div id="wiz2" name="wiz2" class="pb-5" data-wizard-type="step-content">
							...
							<div class="form-group row">
								<div class="col-md-12 col-lg-12">
									<input type="hidden" id="sts2" name="sts2" />
									<button type="button" style="display: none;" id="Simpan2" name="Simpan2" class="btn btn-info font-weight-bolder px-10 py-3" style="float: right;">
										<span class="svg-icon svg-icon-primary svg-icon-1x">
											<i class="flaticon2-accept icon-md"></i>
										</span>&nbsp;Save
									</button>
                        ...
                        <div id="wiz3" name="wiz3" class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="form-group row">
								<div class="col-md-6 col-lg-6">
									<button type="button" id="AddNo" name="AddNo" class="btn btn-info font-weight-bolder px-3 py-3">&nbsp;
										<span class="svg-icon svg-icon-primary svg-icon-2x">
											<i class="far fa-plus-square"></i>
										</span> Sender No.
									</button>
									<button type="button" id="DelNo" name="DelNo" class="btn btn-danger font-weight-bolder px-3 py-3">&nbsp;
										<span class="svg-icon svg-icon-primary svg-icon-2x">
							...
							<div class="form-group row">
								<div class="col-md-12 col-lg-12">
									<input type="hidden" id="sts3" name="sts3" />
									<button type="button" style="display: none;" id="Simpan3" name="Simpan3" class="btn btn-info font-weight-bolder px-10 py-3" style="float: right;">
										<span class="svg-icon svg-icon-primary svg-icon-1x">
											<i class="flaticon2-accept icon-md"></i>
										</span>&nbsp;Save
									</button>
                        ...
                        <div id="wiz4" name="wiz4" class="pb-5" data-wizard-type="step-content">
							...
							<div class="form-group row">
								...
								<div class="col-md-4 col-lg-4">
									<div class="form-group">
										<label>Price Sized Folder</label>
										<input type="text" readonly class="form-control form-control-sm form-control-solid" autocomplete="Off" width="100%" id="pricesized" name="pricesized" placeholder="0" />
									</div>
								</div>
							</div>
							...
							<div class="form-group row">
								<div class="col-md-12 col-lg-12">
									<input type="hidden" id="sts4" name="sts4" />
                                    <input type="hidden" id="idc" name="idc" />
									<button type="button" style="display: none;" id="Simpan4" name="Simpan4" class="btn btn-info font-weight-bolder px-10 py-3" style="float: right;">
										<span class="svg-icon svg-icon-primary svg-icon-1x">
											<i class="flaticon2-accept icon-md"></i>
										</span>&nbsp;Save
									</button>
							...
							<div class="form-group row">
								<!--<div class="col-md-4 col-lg-4">
									<div class="form-group">
										<label>Search Customer Name&nbsp;</label><label style="color: red;"><b>*</b></label>
										<div class="input-group">
											<input type="text" class="form-control form-control-sm" id="caricustname" name="caricustname" required placeholder="Search Customer Name" autocomplete="off" />
											<div class="input-group-append">
												<button type="button" class="btn btn-secondary btn-sm" id="go" name="go"><i class="fa fa-search"></i></button>
											</div>
										</div>
										<div class="fv-plugins-message-container">
											<div data-field="customno" data-validator="notEmpty" class="fv-help-block"></div>
										</div>
									</div>
								</div>-->
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										<label>Customer No.&nbsp;</label><label style="color: red;"><b>*</b></label>
										<input type="text" id="customno" name="customno" class="form-control form-control-sm form-control-solid" readonly placeholder="Customer No." />
										<input type="hidden" id="customid" name="customid" class="form-control form-control-sm" readonly placeholder="Customer Id." />
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										<label>Company Name &nbsp;</label><label style="color: red;"><b>*</b></label>
										<input type="text" class="form-control form-control-sm form-control-solid" width="100%" id="compy_name" name="compy_name" autocomplete="Off" readonly placeholder="Nama Perusahaan *" />
									</div>
								</div>
							</div>
							<hr class="style1" />
                            ...
                            <div class="form-group row">
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input type="number" class="form-control form-control-sm @error('storage_price') is-invalid @enderror" width="100%" id="storage_price" name="storage_price" autocomplete="Off" readonly placeholder="Storage Price *" />
										@error('storage_price')
											<div class="invalid-feedback">{{ $message }}</div>
										@enderror
									</div>
...
$(document).ready(function() 
{
	...
	$("#cari").click(function ()
	{
		...
		$.get("{{ url('/cariCustomer') }}"+'/'+id, function (data) 
		{
			...
			$('#customno').val(data.CUSTOMERNO);
			$('#compy_name').val(data.CUSTOMERNAME);
		})
	...
	$("#go").click(function ()
	{
		var id = $("#caricustname").val();
		
		$.get("{{ url('/cariLokalCustomer') }}"+'/'+id, function (data) 
		{
			$('#customid').val(data.companyid);
			$('#customno').val(data.customerno);
		...
		$.ajax({
			...
			success: function(data)
			{
				...
				for(i=0; i<data.length; i++){
					var j = i + 1;
					html += '<label id=listno'+[i]+' name=listno'+[i]+'>'+j+'. <b>'+data[i].senderno+'</b></label><br />';
				}
				$('#listno').html(html);
			}
		});
	...
	*/
	...
	$('#Simpan1').on("click", function ()
	{
		...
		if(empty(custno) || custno == "")
		{
			$("#notif").html('<div class="alert alert-danger alert-dismissable"><i class="icon fa fa-check"></i><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4> Error. Ada isian yang masih kosong !!! </h4></div>').show();
			setTimeout(function () { $('#notif').hide(); }, 3600);
			$('#searchcustname').focus();
			return false;			
		}

		var cpy_name = $('#cpy_name').val();
		
		var ph_fax = $('#ph_fax').val();
		var picname = $('#picname').val();
		var billname = $('#billname').val();
		
		var cpy_email = $('#cpy_email').val();
		
		var bill_email = $('#bill_email').val();
		if(empty(bill_email) || bill_email == "")
		{
			$("#notif").html('<div class="alert alert-danger alert-dismissable"><i class="icon fa fa-check"></i><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4> Error. Ada isian yang masih kosong !!! </h4></div>').show();
			setTimeout(function () { $('#notif').hide(); }, 3600);
			$('#bill_email').focus();
		...
		var addr_npwp = $('#addr_npwp').val();
		var notes = $('#notes').val();
		var crtby = $('#crtby').val();

		var fd2 = new FormData();
		//customerno,company_name,phone_fax,address,address2,address3,address4,address5,zipcode,address_npwp,email_pic,email_billing,npwpno,npwpname,SALESAGENTCODE,notes,active,activation_date,create_by,create_at,update_by,update_at,isrecord,sized,pathftp,userftp,passwdftp,discount,tech_pic_name,billing_pic_name,fcompleted
		
		fd2.append('customerno', custno);
		fd2.append('company_name', cpy_name);
		fd2.append('phone_fax', ph_fax);
		fd2.append('address', addr);
		fd2.append('address2', addr2);
		fd2.append('address3', addr3);
		fd2.append('address4', addr4);
		fd2.append('address5', addr5);
		fd2.append('zipcode', zipcode);
		fd2.append('address_npwp', addr_npwp);
		fd2.append('email_pic', cpy_email);
		fd2.append('email_billing', bill_email);
		fd2.append('npwpno', npwpno);
		fd2.append('npwpname', npwpname);
		fd2.append('SALESAGENTCODE', sales);
		fd2.append('notes', notes);
		fd2.append('create_by', crtby);
		fd2.append('discount', discount);
		fd2.append('tech_pic_name', picname);
		fd2.append('billing_pic_name', billname);
	...
	$('#Simpan2').on("click", function ()
	{
		...
		var company_id = $('#idc').val();
		
		var user_name = $('#user_name').val();
		var full_name = $('#full_name').val();		
		var passwd = $('#passwd').val();		
		var confirm_passwd = $('#confirm_passwd').val();		
		var user_nameoca = $('#user_nameoca').val();
		var passwdoca = $('#passwdoca').val();		
		var divisi_name = $('#divisi_name').val();
		var concurrent = $('#cc_capacity').val();
		var create_by = $('#crtby').val();

		var fd3 = new FormData();
		
		//id,usernameoca,passwordoca,concurrent,create_by,create_at,update_by,update_at
		//id,company_id,username,password,passwd,full_name,divisi_name,account_group_id,active,create_by,create_at,update_by,update_at,account_id

		fd3.append('company_id', company_id);
		fd3.append('username', user_name);
		fd3.append('full_name', full_name);
		fd3.append('password', passwd);
		fd3.append('passwd', confirm_passwd);
		fd3.append('divisi_name', divisi_name);
		fd3.append('usernameoca', user_nameoca);
		fd3.append('passwordoca', passwdoca);
		fd3.append('concurrent', concurrent);

		fd3.append('create_by', create_by);

		$.ajax({
			url : "{{ url('Registration/InsUser') }}",
			cache: false,
			contentType: false,
			processData: false,
			method : "POST",
			...
			success: function(data)
			{
				...
				if (data.success)
				{
					...
					$('#Simpan2').hide();
					$('#Simpan3').show();
					$("#notif").html('<div class="alert alert-success alert-dismissable"><i class="icon fa fa-check"></i><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4> Done. Master User & Account saved successfully...!!! </h4></div>').show();
					setTimeout(function () { $('#notif').hide(); }, 3600);
				}
				else
				{
	...
	{		
		...
		var ftrial			= $('#trial').val();				
		var create_by		= $('#crtby').val();
		
		var fd4 = new FormData();
		
		//id,company_id,senderno,description,ftrial,fstatus,create_by,create_at,update_by,update_at,senderno_type
		
		fd4.append('company_id', company_id);
		fd4.append('description', description);
		fd4.append('ftrial', ftrial);
		fd4.append('create_by', create_by);

		for (let a = 1; a <= i-1; a++) 
		{
			fd4.append('senderno[]',  $('#senderno'+a+'').val());
			fd4.append('senderno_type[]', $('#notype'+a+'').val());
		}
		//console.log(fd4);
		
		$.ajax({
			url : "{{ url('Registration/InsSenderNo') }}",
			cache: false,
			contentType: false,
			processData: false,
			method : "POST",
			...
			success: function(data)
			{
				...
				if (data.success)
				{
					...
					$('#Simpan3').hide();
					$('#Simpan4').show();
					$("#notif").html('<div class="alert alert-success alert-dismissable"><i class="icon fa fa-check"></i><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4> Done. Sender Numbers were saved successfully...!!! </h4></div>').show();
					setTimeout(function () { $('#notif').hide(); }, 3600);
				}
				else
				{
	...
	$('#Simpan4').on("click", function ()
	{
		...
		var isrecord = $('#record').val();
		var sized = $('#sized').val();
		
		var userftp = $('#userftp').val();		
		var passwdftp = $('#passwdftp').val();

		var fd5 = new FormData();
		
		//isrecord,sized,pathftp,userftp,passwdftp

		fd5.append('company_id', company_id);
		fd5.append('isrecord', isrecord);
		fd5.append('sized', sized);
		fd5.append('userftp', userftp);
		fd5.append('passwdftp', passwdftp);

		$.ajax({
			url : "{{ url('Registration/InsStorage') }}",
			cache: false,
			contentType: false,
			processData: false,
			method : "POST",
			...
			success: function(data)
			{
				...
				if (data.success)
				{
					...
					$("#notif").html('<div class="alert alert-success alert-dismissable"><i class="icon fa fa-check"></i><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4> Done. Master Storage saved successfully...!!! </h4></div>').show();
					setTimeout(function () { $('#notif').hide(); }, 3600);
				}
				else
				{
	...
	$('#Simpan5').on("click", function ()
	{
		...
		fd6.append('company_id', company_id);
		fd6.append('manage_service_price', manage_service_price);
		fd6.append('number_price', number_price);
		fd6.append('concurrent_price', concurrent_price);
		fd6.append('storage_price', storage_price);
		
		fd6.append('pstnbillcycleid', pstnbillcycleid);
		fd6.append('pstn_price', pstn_price);
		fd6.append('gsmbillcycleid', gsmbillcycleid);
		fd6.append('gsm_price', gsm_price);

		fd6.append('create_by', create_by);
	...
	$('#process2').on("click", function ()
	{
		...
		{
			spinner.hide();
			Swal.fire("Warning !", "You must save step 2 to continue... !!!", "error");
			$('#Simpan1').hide();
			$('#Simpan2').show();
			$('#Simpan3').show();
			$('#Simpan4').show();
		...
		{
			spinner.hide();
			Swal.fire("Warning !", "You must save step 3 to continue... !!!", "error");
			$('#Simpan1').hide();
			$('#Simpan2').hide();
			$('#Simpan3').show();
			$('#Simpan4').show();
		...
		{
			spinner.hide();
			Swal.fire("Warning !", "You must save step 4 to continue... !!!", "error");
			$('#Simpan1').hide();
			$('#Simpan2').hide();
			$('#Simpan3').hide();
			$('#Simpan4').show();
		...
		fd7.append('company_id', company_id);

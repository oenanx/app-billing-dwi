...
@section('pageTitle')
	<h4 class="text-dark font-weight-bold my-1 mr-5">New Registration Customer Prepaid</h4>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
		...
		<li class="breadcrumb-item">
			<a href="javascript:;" class="text-muted">1. Form Prepaid</a>
		</li>
		<li class="breadcrumb-item">
			<a href="{{ url('RegistrationPrepaid/newregistration') }}" class="text-muted">New Registration Customer Prepaid</a>
		</li>
	</ul>
@endsection
...
<div class="card card-custom" data-card="true" id="kt_card_1">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-edit"></i> New Registration Customer Prepaid</h3>
		</div>
	...
	<div class="card-body">
		...
		<div class="col-xl-12 col-lg-12">
			...
			@csrf
				...
				<div class="pb-5">
					<h4 class="mb-10 font-weight-bold text-dark">1. New Company Prepaid</h4>
					...
					<div class="form-group row">
						...
						<div class="col-md-6 col-lg-6">
							...
							function hidenlive()
							{
								var t = document.getElementById("flive").value;
								if (t == 1)
								{
									$("#live1").show();
									$("#live2").show();
							...
							<select id="flive" name="flive" class="form-control form-control-sm" required onchange="hidenlive()">
					...
					<div class="form-group row">
						...
						<div id="trial4" class="col-md-3 col-lg-3">
						...
						<div id="trial5" class="col-md-3 col-lg-3">
					...
					<div id="trial6" class="form-group row">
						<div class="col-md-3 col-lg-3">
					...
					<div class="form-group row">
						<div id="trial7" class="col-md-4 col-lg-4">
						...
						<div id="trial8" class="col-md-4 col-lg-4">
					...
					<h4 class="mb-10 font-weight-bold text-dark">2. New Product & Tokens Prepaid</h4>

					<div id="live1" class="form-group row">
						<div class="col-md-3 col-lg-3">
						...
						<div class="col-md-4 col-lg-4">
							...
							function cek1()
							{
								...
								if (quota == "" || quota < 1)
								{
									Swal.fire("Warning !", "The token must be greater than 1 !!!", "error");
									$('#quota1').focus();
									document.getElementById("quota1").focus();
								}
							}
							</script>
							<label for="quota1">Tokens (hits)&nbsp;</label><label style="color: red;"><b>*</b></label>
							<input type="number" class="form-control form-control-sm" width="100%" id="quota1" name="quota1" value="1" min="1" autocomplete="off" required placeholder="Kuota uji coba (hits)" onmouseout="cek1()" />
						</div>
						
						<div class="col-md-5 col-lg-5">
							<label>Rate / hit (Rp.) &nbsp;</label><label style="color: red;"><b>*</b></label>
							<input type="number" class="form-control form-control-sm @error('rates1') is-invalid @enderror" width="100%" id="rates1" name="rates1" autocomplete="Off" min="1" value="0" required placeholder="Price per hit *" />
							@error('rates1')
					...
					<div id="live2" class="form-group row">
						<div class="col-md-3 col-lg-3">
							<label class="checkbox checkbox-lg checkbox-outline checkbox-success" style="vertical-align:middle;">
						...
						<div class="col-md-4 col-lg-4">
							...
							function cek2()
							{
								let quota = document.getElementById("quota2").value;
								if (quota == "" || quota < 1)
								{
									Swal.fire("Warning !", "The quota must be greater than 1 !!!", "error");
									$('#quota2').focus();
									document.getElementById("quota2").focus();
								}
							}
							</script>
							<input type="number" class="form-control form-control-sm" width="100%" id="quota2" name="quota2" value="1" min="1" autocomplete="off" required placeholder="Kuota uji coba (hits)" onmouseout="cek2()" />
						</div>
						
						<div class="col-md-5 col-lg-5">
							<input type="number" class="form-control form-control-sm @error('rates2') is-invalid @enderror" width="100%" id="rates2" name="rates2" autocomplete="Off" min="1" value="0" required placeholder="Price per hit *" />
							@error('rates2')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
					...
					<div id="live3" class="form-group row">
						<div class="col-md-3 col-lg-3">
							<label class="checkbox checkbox-lg checkbox-outline checkbox-success" style="vertical-align:middle;">
						...
						<div class="col-md-4 col-lg-4">
							...
							function cek3()
							{
								let quota = document.getElementById("quota3").value;
								if (quota == "" || quota < 1)
								{
									Swal.fire("Warning !", "The quota must be greater than 1 !!!", "error");
									$('#quota3').focus();
									document.getElementById("quota3").focus();
								}
							}
							</script>
							<input type="number" class="form-control form-control-sm" width="100%" id="quota3" name="quota3" value="1" min="1" autocomplete="off" required placeholder="Kuota uji coba (hits)" onmouseout="cek3()" />
						</div>
						
						<div class="col-md-5 col-lg-5">
							<input type="number" class="form-control form-control-sm @error('rates3') is-invalid @enderror" width="100%" id="rates3" name="rates3" autocomplete="Off" min="1" value="0" required placeholder="Price per hit *" />
							@error('rates3')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
					...
					<div id="trial1" class="form-group row" style="display:none;">
						<div class="col-sm-2 col-md-2">
							<label for="prodapitrial1">Product Trial API&nbsp;</label><label style="color: red;"><b>*</b></label><br />
							<label class="checkbox checkbox-lg checkbox-outline checkbox-success" style="vertical-align:middle;">
								<input type="checkbox" id="prodapitrial1" name="prodapitrial1" required />
								<span> </span>
								&nbsp;&nbsp;VALIDATION API
							</label>
						</div>
						...
						<div class="col-sm-2 col-md-2">
							...
							function cekquota1()
							{
								let quota = document.getElementById("quotatrial1").value;
								if (quota == "" || quota < 1)
								{
									Swal.fire("Warning !", "The token must be greater than 1 !!!", "error");
									$('#quotatrial1').focus();
									document.getElementById("quotatrial1").focus();
								}
							}
							</script>
							<label for="quotatrial1">Trial Tokens (hits)&nbsp;</label><label style="color: red;"><b>*</b></label>
							<input type="number" class="form-control form-control-sm" width="100%" id="quotatrial1" name="quotatrial1" value="1" min="1" autocomplete="off" required placeholder="Token uji coba (hits)" onmouseout="cekquota1()" />
						</div>

						<div class="col-sm-2 col-md-2">
							<label>Rate Trial / hit (Rp.)</label>
							<input type="number" class="form-control form-control-sm" width="100%" id="ratetrial1" name="ratetrial1" value="0" min="0" autocomplete="off" placeholder="Price per hit (Rp)" />
						</div>
						
						<div class="col-sm-3 col-md-3">
							<label for="start_try1">Start Date Trial&nbsp;</label><label style="color: red;"><b>*</b></label>
							<div class="input-group date">
								<input type="text" id="start_try1" name="start_try1" class="form-control form-control-sm datepicker" placeholder="(yyyy-mm-dd)" />
								<div class="input-group-append">
						...
						<div class="col-sm-3 col-md-3">
							<label for="end_try1">End Date Trial&nbsp;</label><label style="color: red;"><b>*</b></label>
							<div class="input-group date">
								<input type="text" id="end_try1" name="end_try1" class="form-control form-control-sm datepicker" placeholder="(yyyy-mm-dd)" />
								<div class="input-group-append">
									<span class="input-group-text"><i class="la la-calendar"></i></span>
								</div>
							</div>
					...
					<div id="trial2" class="form-group row" style="display:none;">
						<div class="col-sm-2 col-md-2">
							<label class="checkbox checkbox-lg checkbox-outline checkbox-success" style="vertical-align:middle;">
								<input type="checkbox" id="prodapitrial2" name="prodapitrial2" required />
								<span> </span>
								&nbsp;&nbsp;SKIPTRACE API
							</label>
						</div>
						...
						<div class="col-sm-2 col-md-2">
							...
							function cekquota2()
							{
								let quota = document.getElementById("quotatrial2").value;
								if (quota == "" || quota < 1)
								{
									Swal.fire("Warning !", "The token must be greater than 1 !!!", "error");
									$('#quotatrial2').focus();
									document.getElementById("quotatrial2").focus();
								}
							}
							</script>
							<input type="number" class="form-control form-control-sm" width="100%" id="quotatrial2" name="quotatrial2" value="1" min="1" autocomplete="off" placeholder="Token uji coba (hits)" onmouseout="cekquota2()" />
						</div>

						<div class="col-sm-2 col-md-2">
							<input type="number" class="form-control form-control-sm" width="100%" id="ratetrial2" name="ratetrial2" value="0" min="0" autocomplete="off" placeholder="Price per hit (Rp)" />
						</div>
						
						<div class="col-sm-3 col-md-3">
							<div class="input-group date">
								<input type="text" id="start_try2" name="start_try2" class="form-control form-control-sm datepicker" placeholder="(yyyy-mm-dd)" />
								<div class="input-group-append">
									<span class="input-group-text"><i class="la la-calendar"></i></span>
								</div>
							</div>
						...
						<div class="col-sm-3 col-md-3">
							<div class="input-group date">
								<input type="text" id="end_try2" name="end_try2" class="form-control form-control-sm datepicker" placeholder="(yyyy-mm-dd)" />
								<div class="input-group-append">
									<span class="input-group-text"><i class="la la-calendar"></i></span>
								</div>
							</div>
					...
					<div id="trial3" class="form-group row" style="display:none;">
						<div class="col-sm-2 col-md-2">
							<label class="checkbox checkbox-lg checkbox-outline checkbox-success" style="vertical-align:middle;">
								<input type="checkbox" id="prodapitrial3" name="prodapitrial3" required />
								<span> </span>
								&nbsp;&nbsp;ID. MATCH API
							</label>
						</div>
						...
						<div class="col-sm-2 col-md-2">
							...
							function cekquota3()
							{
								let quota = document.getElementById("quotatrial3").value;
								if (quota == "" || quota < 1)
								{
									Swal.fire("Warning !", "The token must be greater than 1 !!!", "error");
									$('#quotatrial3').focus();
									document.getElementById("quotatrial3").focus();
								}
							}
							</script>
							<input type="number" class="form-control form-control-sm" width="100%" id="quotatrial3" name="quotatrial3" value="1" min="1" autocomplete="off" placeholder="Token uji coba (hits)" onmouseout="cekquota3()" />
						</div>

						<div class="col-sm-2 col-md-2">
							<input type="number" class="form-control form-control-sm" width="100%" id="ratetrial3" name="ratetrial3" value="0" min="0" autocomplete="off" placeholder="Price per hit (Rp)" />
						</div>
						
						<div class="col-sm-3 col-md-3">
							<div class="input-group date">
								<input type="text" id="start_try3" name="start_try3" class="form-control form-control-sm datepicker" placeholder="(yyyy-mm-dd)" />
								<div class="input-group-append">
									<span class="input-group-text"><i class="la la-calendar"></i></span>
								</div>
							</div>
						...
						<div class="col-sm-3 col-md-3">
							<div class="input-group date">
								<input type="text" id="end_try3" name="end_try3" class="form-control form-control-sm datepicker" placeholder="(yyyy-mm-dd)" />
								<div class="input-group-append">
									<span class="input-group-text"><i class="la la-calendar"></i></span>
								</div>
							</div>
				...
				<div class="d-flex justify-content-between border-top mt-5 pt-10">
					<div class="mr-2">
						...
						<a href="{{ url('RegistrationPrepaid/newregistration') }}">
...
$(document).ready(function() 
{
	...
	$('#Simpan1').on("click", function ()
	{
		...
		if (document.getElementById("flive").value.trim() !== "" || !empty(document.getElementById("flive").value.trim()))
		{
			if (document.getElementById("flive").value.trim() == "1" || document.getElementById("flive").value.trim() == 1)
			{
				if (document.getElementById("prodapi1").checked == true)
				{
					...
					if (document.getElementById("quota1").value.trim() == "" || document.getElementById("quota1").value.trim() < 1)
					{
						document.getElementById("quota1").focus();
						Swal.fire("Warning !", "You must typing a value of quota, must be bigger than 1 hit !!!", "error");
						$('#quota1').focus();
						return false;
					}
				}
				...
				if (document.getElementById("prodapi2").checked == true)
				{
					...
					if (document.getElementById("quota2").value.trim() == "" || document.getElementById("quota2").value.trim() < 1)
					{
						document.getElementById("quota2").focus();
						Swal.fire("Warning !", "You must typing a value of quota, must be bigger than 1 hit !!!", "error");
						$('#quota2').focus();
				...
				if (document.getElementById("prodapi3").checked == true)
				{
					...
					if (document.getElementById("quota3").value.trim() == "" || document.getElementById("quota3").value.trim() < 1)
					{
						document.getElementById("quota3").focus();
						Swal.fire("Warning !", "You must typing a value of quota, must be bigger than 1 hit !!!", "error");
						$('#quota3').focus();
			...
			if (document.getElementById("flive").value.trim() == "2" || document.getElementById("flive").value.trim() == 2)
			{
				if (document.getElementById("prodapitrial1").checked == true)
				{
					if (document.getElementById("quotatrial1").value.trim() == "")
					{
						document.getElementById("quotatrial1").focus();
						Swal.fire("Warning !", "Quota / Token must be greater than 1 !!!", "error");
						$('#quotatrial1').focus();
						return false;
					}
					
					if (document.getElementById("start_try1").value.trim() == "")
					{
						document.getElementById("start_try1").focus();
						Swal.fire("Warning !", "You must type start date for begin of trial period !!!", "error");
						$('#start_try1').focus();
						return false;
					}
					
					if (document.getElementById("end_try1").value.trim() == "")
					{
						document.getElementById("end_try1").focus();
						Swal.fire("Warning !", "You must type end date for end of trial period !!!", "error");
						$('#end_try1').focus();
						return false;
					}
					
					if (document.getElementById("start_try1").value > document.getElementById("end_try1").value)
					{
						document.getElementById("start_try1").focus();
						Swal.fire("Warning !", "The start date cannot be greater than the end date !!!", "error");
						$('#start_try1').focus();
						return false;
					}
					
					if (document.getElementById("quotatrial1").value.trim() == "" || document.getElementById("quotatrial1").value.trim() < 1)
					{
						document.getElementById("quotatrial1").focus();
						Swal.fire("Warning !", "You must type a value of quota trial, must be bigger than 1 hit !!!", "error");
						$('#quotatrial1').focus();
						return false;
					}
				}
				
				if (document.getElementById("prodapitrial2").checked == true)
				{
					if (document.getElementById("quotatrial2").value.trim() == "")
					{
						document.getElementById("quotatrial2").focus();
						Swal.fire("Warning !", "Quota / Token must be greater than 1 !!!", "error");
						$('#quotatrial2').focus();
					...
					if (document.getElementById("start_try2").value.trim() == "")
					{
						document.getElementById("start_try2").focus();
						Swal.fire("Warning !", "You must type start date for begin of trial period !!!", "error");
						$('#start_try2').focus();
						return false;
					}
					
					if (document.getElementById("end_try2").value.trim() == "")
					{
						document.getElementById("end_try2").focus();
						Swal.fire("Warning !", "You must type end date for end of trial period !!!", "error");
						$('#end_try2').focus();
						return false;
					}
					
					if (document.getElementById("start_try2").value > document.getElementById("end_try2").value)
					{
						document.getElementById("start_try2").focus();
						Swal.fire("Warning !", "The start date cannot be greater than the end date !!!", "error");
						$('#start_try2').focus();
					...
					if (document.getElementById("quotatrial2").value.trim() == "" || document.getElementById("quotatrial2").value.trim() < 1)
					{
						document.getElementById("quotatrial2").focus();
						Swal.fire("Warning !", "You must type a value of quota trial, must be bigger than 1 hit !!!", "error");
						$('#quotatrial2').focus();
				...
				if (document.getElementById("prodapitrial3").checked == true)
				{
					if (document.getElementById("quotatrial3").value.trim() == "")
					{
						document.getElementById("quotatrial3").focus();
						Swal.fire("Warning !", "Quota / Token must be greater than 1 !!!", "error");
						$('#quotatrial3').focus();
					...
					if (document.getElementById("start_try3").value.trim() == "")
					{
						document.getElementById("start_try3").focus();
						Swal.fire("Warning !", "You must type start date for begin of trial period !!!", "error");
						$('#start_try3').focus();
						return false;
					}
					
					if (document.getElementById("end_try3").value.trim() == "")
					{
						document.getElementById("end_try3").focus();
						Swal.fire("Warning !", "You must type end date for end of trial period !!!", "error");
						$('#end_try3').focus();
						return false;
					}
					
					if (document.getElementById("start_try3").value > document.getElementById("end_try3").value)
					{
						document.getElementById("start_try3").focus();
						Swal.fire("Warning !", "The start date cannot be greater than the end date !!!", "error");
						$('#start_try3').focus();
					...
					if (document.getElementById("quotatrial3").value.trim() == "" || document.getElementById("quotatrial3").value.trim() < 1)
					{
						document.getElementById("quotatrial3").focus();
						Swal.fire("Warning !", "You must type a value of quota trial, must be bigger than 1 hit !!!", "error");
						$('#quotatrial3').focus();
		...
		{
			var prodapitrial1	= 1;
			var start_trial1	= $('#start_try1').val();
			var end_trial1		= $('#end_try1').val();
			var quotatrial1		= $('#quotatrial1').val();
			var ratetrial1		= $('#ratetrial1').val();
		}
		else
		{
			var prodapitrial1	= 0;
		...
		{
			var prodapitrial2	= 2;
			var start_trial2	= $('#start_try2').val();
			var end_trial2		= $('#end_try2').val();
			var quotatrial2		= $('#quotatrial2').val();
			var ratetrial2		= $('#ratetrial2').val();
		}
		else
		{
			var prodapitrial2	= 0;
		...
		{
			var prodapitrial3	= 3;
			var start_trial3	= $('#start_try3').val();
			var end_trial3		= $('#end_try3').val();
			var quotatrial3		= $('#quotatrial3').val();
			var ratetrial3		= $('#ratetrial3').val();
		}
		else
		{
			var prodapitrial3	= 0;
		...
		fd2.append('create_by', userid); //userid

		fd2.append('billingtype', 1);
		fd2.append('flive', flive);

		fd2.append('prodapi1', prodapi1);
		fd2.append('quota1', quota1);
		fd2.append('rates1', rates1);

		fd2.append('prodapi2', prodapi2);
		fd2.append('quota2', quota2);
		fd2.append('rates2', rates2);

		fd2.append('prodapi3', prodapi3);
		fd2.append('quota3', quota3);
		fd2.append('rates3', rates3);
		
		fd2.append('prodapitrial1', prodapitrial1);
		fd2.append('quotatrial1', quotatrial1);
		fd2.append('ratetrial1', ratetrial1);
		fd2.append('start_trial1', start_trial1);
		fd2.append('end_trial1', end_trial1);

		fd2.append('prodapitrial2', prodapitrial2);
		fd2.append('quotatrial2', quotatrial2);
		fd2.append('ratetrial2', ratetrial2);
		fd2.append('start_trial2', start_trial2);
		fd2.append('end_trial2', end_trial2);

		fd2.append('prodapitrial3', prodapitrial3);
		fd2.append('quotatrial3', quotatrial3);
		fd2.append('ratetrial3', ratetrial3);
		fd2.append('start_trial3', start_trial3);
		fd2.append('end_trial3', end_trial3);

		spinner.show();
		
		$.ajax(
		{
			url : "{{ url('RegistrationPrepaid/InsCust') }}",
			cache: false,
			contentType: false,
			processData: false,
			method : "POST",

...
@section('pageTitle')
	<h1 class="text-dark font-weight-bold my-1 mr-5">Report New Charges Detail</h1>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
		...
		<li class="breadcrumb-item">
			<a href="{{ url('NewChargesDetail/index') }}" class="text-muted">Report New Charges Detail</a>
		</li>
	</ul>
@endsection
...
<div class="card card-custom" data-card="true" id="kt_card_2" style="overflow-x: auto;">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-money"></i> Report New Charges Detail</h3>
		</div>
...
$(document).ready(function() 
{
		...
		dataTable = $('#Show-Tables').KTDatatable(
		{
			...
			data: 	
			{
				...
				source: {
					read: {
						//url: link,
						url: '{{ url('NewChargesDetail/datatable') }}'+'/'+params,
			...
			columns: [
			{
				...
				template: function(data) {
					return '<p style="font-size:10px;">'+data.PERIOD+'</p>';
				}
			},
			{
				field: 'CUSTOMERNO',
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">CUSTOMERNO</p>',
				template: function(data) {
			...
			},
			{
				...
				sortable: false,
				width: 220,
				title: '<p style="font-size:10px;">CUSTOMERNAME</p>',
				template: function(data) {
			...
			},
			{
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">ACTIVATIONDATE</p>',
				template: function(data) {
					return '<p style="font-size:10px;">'+data.activation_date+'</p>';
				}
			},
			{
				field: 'USAGEADJUSTMENT',
				textAlign: 'center',
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">USAGEADJUSTMENT</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.USAGEADJUSTMENT+'</p>';
				}
			},
			{
				field: 'TOTALDISCOUNT',
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">TOTALDISCOUNT</p>',
				template: function(data) {
			...
			},
			{
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">PREVIOUSBALANCE</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.PREVIOUSBALANCE+'</p>';
				}
			},
			{
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">BALANCEADJUSTMENT</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.BALANCEADJUSTMENT+'</p>';
				}
			},
			{
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">PREVIOUSPAYMENT</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.PREVIOUSPAYMENT+'</p>';
				}
			},
			{
				field: 'TOTALAMOUNT',
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">TOTALAMOUNT</p>',
				template: function(data) {
			...
			},
			{
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">REVENUE</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.REVENUE+'</p>';
				}
			},
			{
				field: 'TOTALVAT',
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">TOTALVAT</p>',
				template: function(data) {
			...
			},
			{
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">NEWCHARGE</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.NEWCHARGE+'</p>';
				}
			},
			{
				field: 'NEWBALANCE',
				...
				sortable: false,
				width: 120,
				title: '<p style="font-size:10px;">NEWBALANCE</p>',
				template: function(data) {
					return '<p style="font-size:10px; text-align: right;">'+data.NEWBALANCE+'</p>';
				}
			},
			{
				...
				sortable: false,
				width: 140,
				title: '<p style="font-size:10px;">SALESAGENT</p>',
				template: function(data) {
					return '<p style="font-size:10px;">'+data.SALESAGENTNAME+'</p>';
				}
			}],
		});
	...
	$('#downloaddata').on("click", function ()
	{
		...
		var params = thn+''+bln;
		//console.log(params);
		var url = "{{ url('NewChargesDetail/download') }}"+'/'+params;

...
@section('pageTitle')
	<h1 class="text-dark font-weight-bold my-1 mr-5">Report Non NPWP</h1>
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
		...
		<li class="breadcrumb-item">
			<a href="{{ url('NewChargesDescription/index') }}" class="text-muted">Report Non NPWP</a>
		</li>
	</ul>
@endsection
...
<div class="card card-custom" data-card="true" id="kt_card_2">
	<div class="card-header">
		<div class="card-title">
			<h3 class="card-label"><i class="fa fa-money"></i> Report Non NPWP</h3>
		</div>
...
$(document).ready(function() 
{
		...
		dataTable = $('#Show-Tables').KTDatatable(
		{
			...
			data: 	
			{
				...
				source: {
					read: {
						//url: link,
						url: '{{ url('NonNPWP/datatable') }}'+'/'+params,
	...
	$('#downloaddata').on("click", function ()
	{
		...
		var params = thn+''+bln;
		//console.log(params);
		var url = "{{ url('NonNPWP/download') }}"+'/'+params;
